...
ALLOWED_HOSTS = ['api01.pythonanywhere.com']
Esto es cuando esta en la nube
"""
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "API El Sistema",


    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "API El Sistema",

    

    # Logo to use for your site, must be present in static files, used for brand on top left
    "site_logo": "imagenes/logo1.jpg",
    ...
    "copyright": "Hecho por: Jesus Medina",
